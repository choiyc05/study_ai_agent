...
def main():
  ...
  #   # step4.run(dataset)
  #   step6.run(dataset, "20260403_0947/001.pth")
  # print("4. Step 5: 모델 테스트")
  # step5.run("20260403_0947")
  # print("5. Step 7: 모델 변환")
  # step7.run("20260403_0947/001.pth", 1)
  # print("6. Step 8: 모델 테스트")
  # step8.run("20260403_1043/001.safetensors")
  step9.run("20260403_1043")
